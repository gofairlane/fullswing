...
<?php get_header(); ?>
    		...
    		<div id="inner-content" class="wrap cf">
				<?php /* Widgetized sidebar */
    				if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Home Pros Section') ) : ?><?php endif; ?>
			...
			<footer class="article-footer">
					...
					<?php /* Widgetized sidebar */
    				if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Call To Action Section') ) : ?><?php endif; ?>	
